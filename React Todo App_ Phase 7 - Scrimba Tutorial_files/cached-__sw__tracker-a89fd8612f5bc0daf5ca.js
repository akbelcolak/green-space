...
return function(r){return r!=null&&{}.toString.call(t?r[t]:r)===e}}},function(e,t,r){function n(e){return e&&(e.len instanceof Function?e.len():e.length)||0}function i(e){return e?e.toArray?e.toArray():e:[]}var o=t.VERSION=2
var a=t.SPIV=2
...
var y=t.AGENT=Object.create(p)
var m=t.POINTER=Object.create(p)
...
m.STATEFLAGS={LEFT_BUTTON:1,RIGHT_BUTTON:2,MIDDLE_BUTTON:4,HIDDEN:8,TRANSITION:16,HIGHLIGHT:32,CTRL:64,ALT:128,SHIFT:256}
m.FLAGS={Created:1,Enabled:2,Deleted:4,Visible:8}
m.STYLES={DEFAULT:0,ROW:1,SMALL_FLIPPED:2}
...
this}t.Packet=x
x.prototype.params=function(e){return this._params}
x.prototype.setParams=function(e){this._params=e
return this}
x.prototype.socket=function(e){return this._socket}
x.prototype.setSocket=function(e){this._socket=e
return this}
x.prototype.data=function(e){return this._data}
x.prototype.setData=function(e){this._data=e
return this}
x.prototype.payloadSize=function(){return this._data.byteLength-this._offset}
x.prototype.retain=function(){if(false){}return this}
x.prototype.payload=function(){if(false){}else{return this._payload||(this._payload=this._data.subarray(this._offset))}}
x.prototype.reply=function(e){if(this._ref){e=N.concat([C.encode(this._ref),e])}this.socket().send(e)
return this}
x.prototype.sid=function(){return this.socket().sid}},function(e,t){function r(e,t,r){if(t in e){return e[t]}else if(arguments.length===3){return r}else{throw new Error('"'+t+'" is a required argument.')}}t.getArg=r
var n=/^(?:([\w+\-.]+):)?\/\/(?:(\w+:\w+)@)?([\w.]*)(?::(\d+))?(\S*)$/
var i=/^data:.+\,.+$/
...
if(r!==0){return r}return y(e.name,t.name)}t.compareByGeneratedPositionsInflated=m},function(e,t){var r={}
...
x.toArray=g
if(s)x.toBuffer=y
if(u)x.toArrayBuffer=m
P[L]=I
t[e]=P
return P
function P(e,t,r,n){if(!(this instanceof P))return new P(e,t,r,n)
return k(this,e,t,r,n)}function I(e){return!!(e&&e[M])}function k(e,t,r,n,s){if(u&&f){if(t instanceof f)t=new u(t)
...
if(isNaN(s))return a
e[r+a]=s}return a}function T(e,t,r,n){return ee($(t,e.length-r),e,r,n)}function O(e,t,r,n){return ee(J(t),e,r,n)}function C(e,t,r,n){return O(e,t,r,n)}function N(e,t,r,n){return ee(Z(t),e,r,n)}function x(e,t,r,n){return ee(Q(t,e.length-r),e,r,n)}f.prototype.write=function e(t,r,n,i){if(r===undefined){i="utf8"
n=this.length
...
case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return x(this,t,r,n)
...
function L(e,t,r){if(t===0&&r===e.length){return n.fromByteArray(e)}else{return n.fromByteArray(e.slice(t,r))}}function M(e,t,r){r=Math.min(e.length,r)
var n=[]
var i=t
while(i<r){var o=e[i]
var a=null
...
if(!r||r<0||r>n)r=n
var i=""
for(var o=t;o<r;++o){i+=W(e[o])}return i}function D(e,t,r){var n=e.slice(t,r)
var i=""
...
function Y(e,t,r,n){if(t<0)t=4294967295+t+1
...
this[r+2]=t>>>16
this[r+1]=t>>>8
this[r]=t&255}else{Y(this,t,r,true)}return r+4}
...
this[r+1]=t>>>16
this[r+2]=t>>>8
this[r+3]=t&255}else{Y(this,t,r,false)}return r+4}
...
this[r+1]=t>>>8
this[r+2]=t>>>16
this[r+3]=t>>>24}else{Y(this,t,r,true)}return r+4}
...
this[r+2]=t>>>8
this[r+3]=t&255}else{Y(this,t,r,false)}return r+4}
function z(e,t,r,n,i,o){if(r+n>e.length)throw new RangeError("Index out of range")
if(r<0)throw new RangeError("Index out of range")}function V(e,t,r,n,o){if(!o){z(e,t,r,4,3.4028234663852886e38,-3.4028234663852886e38)}i.write(e,t,r,n,23,4)
...
function H(e,t,r,n,o){if(!o){z(e,t,r,8,1.7976931348623157e308,-1.7976931348623157e308)}i.write(e,t,r,n,52,8)
...
var K=/[^+\/0-9A-Za-z-_]/g
function q(e){e=X(e).replace(K,"")
if(e.length<2)return""
while(e.length%4!==0){e=e+"="}return e}function X(e){if(e.trim)return e.trim()
return e.replace(/^\s+|\s+$/g,"")}function W(e){if(e<16)return"0"+e.toString(16)
...
i=r%256
o.push(i)
o.push(n)}return o}function Z(e){return n.toByteArray(q(e))}function ee(e,t,r,n){for(var i=0;i<n;++i){if(i+r>=t.length||i>=e.length)break
...
var i=r(1),o=i.SCON,a=i.KEYS,s=i.ACTION
...
return c}},function(e,t,r){t.DecodeBuffer=o
var n=r(10).preset
var i=r(19).FlexDecoder
i.mixin(o.prototype)
function o(e){if(!(this instanceof o))return new o(e)
if(e){this.options=e
...
var r=e&&e.int64
var n=f&&e&&e.usemap
var i={map:n?p:h,array:d,str:v,bin:t?y:g,ext:m,uint8:_,uint16:w,uint32:b,uint64:R(8,r?C:T),int8:E,int16:A,int32:S,int64:R(8,r?N:O),float32:R(4,x),float64:R(8,L)}
...
return t.call(r.buffer,n,c)}}function T(e){return new o(this,e).toNumber()}function O(e){return new a(this,e).toNumber()}function C(e){return new o(this,e)}function N(e){return new a(this,e)}function x(e){return n.read(this,e,false,23,4)}function L(e){return n.read(this,e,false,52,8)}},function(e,t){var r=t.uint8=new Array(256)
for(var n=0;n<=255;n++){r[n]=i(n)}function i(e){return function(t){var r=t.reserve(1)
t.buffer[r]=e}}},function(e,t){var r=/(?:^\uFEFF?|[^$_a-zA-Z\xA0-\uFFFF."'])require\s*\(\s*("[^"\\]*(?:\\.[^"\\]*)*"|'[^'\\]*(?:\\.[^'\\]*)*')\s*\)/g
var n=/(^|[^\\])(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm
var i=/("[^"\\\n\r]*(\\.[^"\\\n\r]*)*"|'[^'\\\n\r]*(\\.[^'\\\n\r]*)*')/g
var o=/^\#\!.*/
...
if(f.match(/"|'/))continue
t.push(f)}}return t}e.exports=a},function(e,t,r){var n=r(2)
...
var a=console
var s=r(14)
var u=r(1),f=u.ACTION,c=u.KEYS,l=u.SCON
var h=r(33)
...
v.push([i.fileName,i.lineNumber,i.columnNumber])}}return[c.ERROR,t.name,d,v]}else if(t&&t._dom){t=t._dom}if(t&&t.nodeType&&t.nodeName){if(t.SCRIMBA_INDEX){a.log("Logged node has SCRIMBA_INDEX",t,t.SCRIMBA_INDEX)}return[c.ELEMENT,t.outerHTML]}else if(typeof t=="object"){if(t.type=="error"){if(t.shim){return t}t.shim=1
...
return this}},function(e,t,r){function n(e){return e&&(e.len instanceof Function?e.len():e.length)||0}var i=r(1).ACTION
function o(e){this._browser=e
this._index=0
this._stack=[]
this}t.History=o
o.prototype.index=function(e){return this._index}
o.prototype.setIndex=function(e){this._index=e
return this}
o.prototype.replace=function(e){this._stack[this._index]=e
return this}
o.prototype.push=function(e){this._stack=this._stack.slice(0,this._index+1)
this._index=this._stack.push(e)-1
return this}
o.prototype.trim=function(){this._stack=this._stack.slice(0,this._index+1)
return this}
o.prototype.go=function(e,t){if(t===undefined)t=false
var r=this._index+e
var n=this._stack[this._index=r]
return n}
o.prototype.apply=function(e,t){var r=[this._index,this._stack.slice()]
if(t==null){this.push(e)}else if(t==0){this.replace(e)}else{let r=this.go(t)
this.replace(e)}return r}
o.prototype.reset=function(e){e||(e=[-1,[]])
this._index=e[0]
this._stack=e[1]
return this}
o.prototype.current=function(){return this._stack[this._index]}
o.prototype.relative=function(e){return this._stack[this._index+e]}
...
o.prototype.state=function(){return[this._index,this._stack]}},function(e,t,r){function n(e){return e&&(e.len instanceof Function?e.len():e.length)||0}function i(e){return e?e.toArray?e.toArray():e:[]}var o=r(1),a=o.DOM,s=o.POINTER,u=o.CONSOLE,f=o.SCON,c=o.ACTION
...
t=o[e]
if(t){r._sourceMaps["/"+e]=new l(t)}}}t.PackageLoader=m
...
return e.fileName=t.sources[0]}}}).call(t,r(55))},function(e,t){if(typeof window!="undefined"){(function(e){if(typeof e.matches!=="function"){e.matches=e.msMatchesSelector||e.mozMatchesSelector||e.webkitMatchesSelector||function e(t){var r=this
...
var parseDeps=__webpack_require__(22)
...
return this}},function(e,t,r){(function(e){function n(e){return e?e.toArray?e.toArray():e:[]}var i=r(22)
var o=r(3).dirname
...
function u(e){this._unpkgServer="https://unpkg.scrimba.com"
this._spec=e
...
await t.fetch()
if(!t.ok()){throw new Error("No such file: "+this.path()+" (in {"+this._spec+"})")}return{body:t.body(),parseDeps:t.parseDeps()}}
...
var s=a.browser
if(typeof s=="object"){this._browser=s}if(e=a.unpkg){if(a.name!="react-redux"){n=false}i=e}else if(typeof s=="string"){i=s}else if(t=a.main){i=t}i=o(i)}this._indexPath=this.resolvePathSync(i)
...
return this}
f.prototype.json=function(){return this._json||(this._json=JSON.parse(this.body()))}},function(e,t,r){t.encode=r(18).encode
t.decode=r(16).decode
...
e.addExtPacker(29,DataView,o)}if(n.hasBuffer){e.addExtPacker(27,i,n.from)}}function f(e){if(!a)a=r(18).encode
...
e.addExtUnpacker(29,[h,l(DataView)])}if(n.hasBuffer){e.addExtUnpacker(27,l(i))}}function u(e){if(!o)o=r(16).decode
...
r(11)
t.createCodec=r(5).createCodec},function(e,t,r){var n=r(20)
t.getReadToken=i
...
m(e,t)}function C(e,t){if(v(t))return B(e,t)
O(e,t)}function N(e,r){var n=192
t[n](e,r)}function x(e,r){var n=r.length
...
t[i](e,n)
e.send(r)}function M(e,t){L(e,new Uint8Array(t))}function P(e,r){var n=r.buffer
var i=n.length
...
if(s<0){return-1}while(s-1>=0){if(o(i[s],i[s-1],true)!==0){break}--s}return s}},function(e,t,r){var n=r(2)
...
var l=u+1
i(e,t,o,l-1)
i(e,t,l+1,a)}}t.quickSort=function(e,t){i(e,t,0,e.length-1)}},function(e,t,r){var n=r(2)
var i=r(57)
var o=r(23).ArraySet
var a=r(24)
...
u.prototype["set"+t(o[l])]=function(e){return function(t){this[e]=String(t)}}(o[l])}return u})},function(e,t,r){function n(e){return e?e.toArray?e.toArray():e:[]}var i=r(1),o=i.ACTION,a=i.KEYS
var s=r(29).Recorder
var u=r(27).ConsoleShim
var f=r(28).History
var c=console
var l=/^((?!chrome|android).)*safari/i.test(window.navigator.userAgent)
var h=r(30).PackageLoader
...
var i=t
t._request=window.SCRIMBA_REQUEST||{state:{}}
t._status=window.SCRIMBA_STATUS||200
t._receiver=e
t._history=(new f).reset(t._request.state.history)
...
var o=n.pushState
var a=n.replaceState
var s=n.go
n.nativeGo=s
n.pushState=function(e,t,r){var n=o.apply(this,arguments)
i.history().push(r)
i.post({type:"history",action:"pushState",url:r,state:e})
return n}
n.replaceState=function(e,t,r){var n=a.apply(this,arguments)
i.post({type:"history",action:"replaceState",url:r,state:e})
i.history().replace(r).trim()
return n}
n.go=function(e){let t=i.history().relative(e)
if(t){i.post({type:"history",action:"go",delta:e})
let t=n.nativeGo(e)
i.history().go(e)
return t}}
n.forward=function(){return this.go(1)}
n.back=function(){return this.go(-1)}
window.addEventListener("pageshow",function(e){return true},true)
window.addEventListener("pagehide",function(e){return true},true)
window.addEventListener("popstate",function(e){return t.post({type:"history",action:"popState",url:document.location.href,state:e.state})},true)
...
window.addEventListener("beforeunload",function(e){t.post({type:"beforeunload",predictedTarget:window.SCRIMBA_EXIT_HREF})
return},true)
window.addEventListener("unload",function(e){return t.post({type:"unload"})},true)
...
t._console.queue()
document.addEventListener("DOMContentLoaded",function(e){if(p){t.log("DOMContentLoaded",document.documentElement.innerHTML)}t.domContentLoaded()
return t._console.flush()})
t.post({type:"pageload",status:t._status,url:r})}d.prototype.history=function(e){return this._history}
d.prototype.setHistory=function(e){this._history=e
return this}
...
if(e.type=="reload"){return window.location.reload()}else if(e.type=="forward"){return window.history.go(1)}else if(e.type=="back"){return window.history.go(-1)}else if(e.type=="go"){return window.history.go(e.delta)}else if(e.type=="stylesheet"){let t
let i=window.document.querySelectorAll("link[rel=stylesheet]")
this.log("msg stylesheet",e)
for(let t=0,r=n(i),o=r.length,a;t<o;t++){a=r[t]
let n=new URL(a.href)
if(n.pathname==e.path){this.log("found matching sheet",a)
let e=a.getAttribute("href").split("?")[0]+"?"+Math.random()
a.href=e}}if(r=window.document.querySelector("style[scrimba-live='"+e.path+"']")){r.SCRIMBA_IGNORE=true
